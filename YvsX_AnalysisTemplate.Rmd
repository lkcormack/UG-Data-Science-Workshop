---
title: "Your Y vs. X Project Title Here"
...
> In the code cell below, make a plot of the data distributions for your two variables,  
...
> Below, add a best-fit line with 95% confidence bands to your plot.
...
> Interprete the plot here - how should we interpret the slope
> in terms of the confidence band?

---

> Compute the table best-fit coefficients and their associated statisics

```{r}
 # compute linear model
```

> Interpret the slope coefficient in light of it's p-value and standard error.
